        ...
        <div className="Intro" id="Intro">
            ...
            <div className="i-left">
                <div data-aos="fade-up" className="i-name">
                    ...
                    <span>Tanish Jain</span>
                    <span>
                    React-Native Developer at The Coding Studio with expertise in Application Making, producing the Quality work to entice and engage your users!
                    </span>
                </div>
            ...
            <div data-aos="fade-left" className="i-right">
                ...
                >
                    <FloatinDiv img={crown} text1="React-Native" text2="Developer" />
                </motion.div>
                <motion.div
